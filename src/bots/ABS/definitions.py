...
OUTPUT_FOLDER=base_dir+"/storage/output"
...
login_button= r'//*[@id="R407540906319251997"]/div[2]/table/tbody/tr/td[2]/a'
...
#temp folders list
folders = ["temp_data", "temp_data/cropped", "temp_data/full", "temp_data/live_pic", "temp_data/nid_back", "temp_data/nid_front", "temp_data/nom_img",'temp_data/customer2_nid_front',
